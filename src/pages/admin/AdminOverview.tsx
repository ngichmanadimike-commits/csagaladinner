...
const AdminOverview = () => {
  ...
  const quickActions = [
    ...
    { label: "Event Configuration", desc: "Create and configure events", path: "/admin/event-config", icon: Calendar },
          ...
          <div className="glass rounded-xl p-4 mb-8">
            ...
            <div className="flex items-end gap-2 h-40">
              {chartData.map((d) => {
                ...
                return (
                  <div key={d.day} className="flex-1 flex-col items-center gap-1">
                    <div className="w-full flex-col-reverse gap-px h-32">
                      <div
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {quickActions.map((action) => (
                <button
                  ...
                  className="glass rounded-xl p-4 text-left hover:border-primary/50 border-transparent transition-all group"
                >
